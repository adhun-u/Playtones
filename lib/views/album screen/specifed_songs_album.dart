...
class SpecifedSongsAlbum extends StatelessWidget {
  const SpecifedSongsAlbum({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<FetchAlbumBloc, FetchAlbumState>(
        builder: (context, state) {
          if (state is AlbumBasedSongsState) {
            return Stack(
              children: [
                Container(
                  height: size.height,
                            ...
                            return ListTile(
                              onTap: () {
                                if (provider.songId == song.id) {
                                  ...
                                  //Defined the function at bottom of the file
                                  playOperations(context, index, song);
                                }
  ...
  //--------------------------------------------------------------------------
  void playOperations(BuildContext context, int index, SongModel song) {
